...
export class Rol {
  ...
  @ApiProperty({
    example: false,
    description: 'Indica si el rol hereda permisos de otros roles',
  })
...
export class Permission {
  ...
  @ApiProperty({
    example: 'Permite crear un nuevo usuario',
  ...
  @ApiPropertyOptional({
    type: () => Rol,
    description: 'Rol asociado al permiso (opcional)',
  })
  rol?: Rol;
...
export class Module {
  ...
  @ApiProperty({
    example: 'Módulo para la gestión de usuarios',
  ...
  @ApiProperty({
    example: false,
    description: 'Indica si el módulo es parte del sistema base',
  })
  isSystemModule: boolean;

  @ApiProperty({
    type: () => [Permission],
    description: 'Lista de permisos asociados al módulo',
  })
  permissions: Permission[];

  @ApiProperty({
    type: () => [Rol],
    description: 'Lista de roles asociados al módulo',
  })
  roles: Rol[];
}
